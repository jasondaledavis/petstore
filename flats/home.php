  ...
  <div class="narrow">
    ...
    <div class="flex-row">
      ...
      <div class="flex-col-sm-5">
        <img src="/temp-images/home-photo.png" alt=""/>
      </div>
    </div>
          ...
          <div class="claim-slide swiper-slide">
            <div class="flex-row page-width">
              ...
              <div class="flex-col-sm-4">
                <img class="round-image" src="/temp-images/macduff.png" alt=""/>
              </div>
            </div>
          </div>
          <div class="claim-slide swiper-slide">
...
<div class="post-cards-container flex-container fullbleed bg-light-1">
  ...
  <div class="narrow">
    ...
    <div class="post-cards">
        ...
        <div class="post">
          <img class="post-image" src="/temp-images/blog-card1.png" alt=""/>
          ...
          <div class="author-area">
              <img src="/temp-images/Author-Bio-Katie-Blakely.jpg" class="author-icon" alt="">
        ...
        <div class="post">
          <img class="post-image" src="/temp-images/blog-card2.png" alt=""/>
          <div class="post-content">
            <p class="text-primary bold">Winter Hiking with Your Dog</p>
            <p>True adventurers know that the escapades don’t have to stop when the temperatures drop...</p>
          </div>
        ...
        <div class="post">
          <img class="post-image" src="/temp-images/blog-card3.png" alt=""/>
          <div class="post-content">
            <p class="text-primary bold">Winter Hiking with Your Dog</p>
            <p>True adventurers know that the escapades don’t have to stop when the temperatures drop...</p>
          </div>
