...
<div class="flex-container fullbleed bg-light-1">
  ...
  <div class="flex-container claim-tale nopad fullbleed" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/Full-Width-Banner-Claim-Tale-MacDuff.jpg); background-position: center;
