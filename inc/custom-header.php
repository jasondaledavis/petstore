 ...
 *
 * @uses petfirst_header_style()
 */
function petfirst_custom_header_setup() {
...
add_action( 'after_setup_theme', 'petfirst_custom_header_setup' );

if ( ! function_exists( 'petfirst_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see petfirst_custom_header_setup().
	 */
